...
- Advanced Damage Techniques
  ...
  - We also make use of some important enums taken from TStructOpsTypeTraits (WithNetSerializer and WithCopy) to set to true, and Duplicate() function also overriden.
  - 