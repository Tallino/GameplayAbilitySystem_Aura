...
- Experience and Leveling Up
  ...
  - So now we create our IncomingXP meta attribute (of type FGameplayAttributeData) in AuraAttributeSet class: just like for the IncomingDamage, in PostGameplayEffectExecute we check if the attribute in question is the IncomingXP, and in case it is, we get it and store it.