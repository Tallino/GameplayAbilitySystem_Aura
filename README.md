...
- Enemy Finishing Touches
  ...
  - For other small additions, we add hurt sounds in BP (in the Anim Montage of the HitReact) and death sounds in C++ (in multiDeath function implementation) to goblin spears. 