...
---
 ...
 - Enemy Melee Attacks
   ...
   - Just like we did for Aura, we add motion warping component to the enemy, and Motion Warping anim notify state to its spear-attack animation. In the Enemy BP we call the Add Motion Warping from blueprint implementable event that will be then called
