...
- Spell Menu
  ...
  - Finally, to make the overlay update too, we simply create the same exact version of OnAbilityEquipped on the OverlayWidgetController, as it is already subscribed to the same delegate and therefore broadcasts the same AbilityInfo.